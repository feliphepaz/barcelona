            ...
            <div class='menu-redes'>
                <div class='redes'>
                    ...
                    <ul class='redes-lista'>
                        <li><a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/facebook.svg" alt=""></a></li>
                        <li><a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/instagram.svg" alt=""></a></li>
                        <li><a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/tweet.svg" alt=""></a></li>
                    </ul>
                </div>
                <nav>
                    <ul class='menu'>
